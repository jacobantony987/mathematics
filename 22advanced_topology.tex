...
\begin{theorem}
	...
	\begin{enumerate}
		...
		\item Existence of left and right identies\\
			...
			\begin{commentary} That is, $e_{x_0},\ e_{x_1}$ are respectively the left and right path-homotopy-identities. \end{commentary}
		\item Existence of inverse\\
			...
			\begin{commentary} That is, the inverse of class of $f$ is the class of reverse path of $f$. \end{commentary}
	\end{enumerate}
	\begin{commentary}
...
\begin{theorem}
	Let $f$ be a path in $X$, and $a_0, a_1, \cdots, a_n$ be numbers such that $0 = a_0 < a_1 < \cdots < a_n = 1$. Let $f_i : I \to X$ be the path that equals the positive linear map of $f$ onto $[a_{i-1},a_i]$ followed by $f$. Then $[f] = [f_1]\ast{}[f_2]\ast{}\cdots[f_n]$.
