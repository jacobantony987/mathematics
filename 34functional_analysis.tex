...
\begin{tikzpicture}[scale=0.8]
	...
	\draw (-3.8,-0.8) node{$x$};
	\draw[olive] (-3.6,0.2) circle (0.05cm);
	\draw[olive] (-4.0,0.4) node{$x_0$};
	\draw (3,-0.6) circle (0.05cm);
	\draw (3.6,-0.8) node{$Tx$};
	\draw (-3,0.4) circle (0.05cm);
	\draw (-2.2,0.8) node{$T^\ast y$};
	\draw (3.4,0.4) circle (0.05cm);
	\draw (3.8,0.6) node{$y$};
	\draw[olive] (3.6,-0.2) circle (0.05cm);
	\draw[olive] (4.0,-0.4) node{$y_0$};
	...
	\draw (0,-1) node{$T$};
	\draw[-latex,blue] (3.4,0.4) -- (-3,0.4);
	\draw (0,0) node{$T^\ast$};
	\draw[-latex,purple] (3.4,4.6) -- (3.4,0.4);
	\draw[purple] (-3.7,2) node{$A_1$};
	\draw[-latex,purple] (-3.4,4.6) -- (-3.4,-0.6);
	\draw[purple] (3.7,2) node{$A_2$};

	\draw[-latex,olive] (3.4,0.4) -- (0,3);
	\draw[olive] (2,2) node{$g$};
	\draw[olive] (0,3) circle (0.05cm);
	\draw[olive] (0,2.5) node{$\inner{y}{y_0}$};
	\draw[-latex,olive] (-3.4,-0.6) -- (0,1);
	\draw[olive] (-1,0) node{$f$};
	\draw[olive] (0,1) circle (0.05cm);
	\draw[olive] (0,1.5) node{$\inner{x}{x_0}$};
\end{tikzpicture}
