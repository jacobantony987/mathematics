...
\end{table}
\begin{remark}Practise Problems
	\begin{enumerate}
		\item Given $\{(0,7),\ (2,11),\ (3,28)\}$, interpolate $y$ at $x=1$ ?
		\item Given $\{(-2,-1),\ (1,2),\ (4,59),\ (-1,4),\ (3,24),\ (-4,-53) \}$, find interpolation polynomial by Newton's Method ? (\cite[Example 3.2]{kiusalaas})
	\end{enumerate}
\end{remark}
