...
\end{theorem}
\begin{proof}
	Suppose a sequence $\{ f_n \}$ of bounded, measurable functions converges uniformly to $f$ on a set of fintie measure $E$.
...
\begin{proof}
	...
	And if $f$ is a bounded, measurable function with finite support, then $f \cdot \chi_A$ is also a bounded, measurable function with fintie support for any measurable subet $A \subset E$.
...
\begin{proof}
	...
	\begin{align*}
		...
		\int_E g - \int_E f {\color{red}\le} & \liminf \int_E g_n - \limsup \int_E f_n
		\intertext{Then,}
		\limsup \int_E f_n \le & \int_E f
	\end{align*}
	...
	\begin{align*}
		\int_E (g+f) \le & \liminf \int_E (g_n+f_n) \\
		\int_E g + \int_E f {\color{red}\le} & \liminf \int_E g_n + \liminf \int_E f_n
		\intertext{Then,}
...
\begin{enumerate}
	\item $(\mathbb{R},\mathcal{L},m)$ Lebesgue Measure Space
	\item $(\mathbb{R},\mathcal{B},m)$ 
	\item $(X,2^X,\eta)$ Counting Measure where $\eta(A) = |A|$.
	\item $(X,\mathcal{M},\delta_{x_0})$ Dirac Measure where $\delta_{x_0}(A) = \begin{cases}1 & x_0 \in A \\ 0 & x_0 \notin A \end{cases}$.
	\item $(X,\mathcal{C},\mu)$ \\
		$\mathcal{C}$ is the family of all countable subsets and their complements.\\
		And $\mu(A) = \begin{cases} 0 & A \text{ is countable} \\ 1 & A^c \text{ is countable} \end{cases}$.
\end{enumerate}

	\textbf{Note :} Let $(X,\mathcal{M},\mu)$ be a measure space.
	Let $X_0 \in \mathcal{M}$.
	Then $(X_0,\mathcal{M}_0,\mu_0)$ is also a measure space where $\mathcal{M}_0 = \mathcal{M}$ respectricted to $X_0$ and $\mu_0$ is $\mu$ restricted to $X_0$.
