...
\item \textbf{Continous, real-valued functions are measurable}\\
	...
	\begin{proof}
	\end{proof}
\item \textbf{Monotone functions on an interval are measurable}\\
	...
	\end{proof}
\item \textbf{$f$ measurable $\implies$ $g$ measurable ($f = g$  a.e.)}\\
	If $f$ is measurable and $f = g$ a.e.(almost everywhere).
