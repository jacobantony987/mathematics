...
\begin{theorem}
	...
	\begin{enumerate}
		...
		\item Additivity over domain of integration\\
			...
			\end{equation}
		\item Suppose $X_0 \subset X$ such that $\mu(X_0 \sim X) = 0$, then
			\begin{equation}
...
\begin{theorem}[countably additivity over the domain of integration]
	...
	Then
	$$ \int_X f \ d\mu = \sum_{n=1}^\infty \int_{X_0} f \ d\mu $$
\end{theorem}
\begin{proof}
\end{proof}
...
\begin{theorem}[continuity of integation]
	...
	\begin{enumerate}
		\item If $\{ X_n \}_{n=1}^\infty$ is an ascending collection of measurable sets whose union is $X$.
			Then
			$$ \int_X f \ d\mu = \lim_{n \to \infty} \int_{X_0} f \ d \mu $$
		\item If $\{ X_n \}_{n =1}^\infty$ is a descending collection of measurable sets, then
			$$ \int_{\cap_{n = 1}^\infty X_n} f \ d\mu = \lim_{n \to \infty} \int_{X_0} f \ d\mu $$
	\end{enumerate}
\end{theorem}
\begin{proof}
\end{proof}
...
\begin{theorem}
	...
	Furthermore, for any $\epsilon > 0$, there exists a subset of finite measure $X_0 \subset X$ such that $\displaystyle \int_{X \sim X_0} |f_n| \ d\mu < \epsilon$.
\end{theorem}
\begin{proof}
\end{proof}
...
\begin{theorem}[Vitali Convergence theorem]
	...
	Suppose $\{ f_n \}$ conveges to function $f$ pointwise a.e. on $X$ and $f$ is integrable over $X$.
	Then,
