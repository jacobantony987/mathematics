...
\paragraph{Existence}
	...
	And we may also prove existence without actually giving an object. %Existence of torsion subgroup can be proved by demonstrating the existence of identity, invese elements and also the closure of the operator.

\begin{itemize}
	\item Existence of generator : Cyclic group test
%	\item Existence of torsion subgroup
%	\item Existence of a maximal normal subgroup
\end{itemize}
\pagebreak
