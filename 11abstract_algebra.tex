...
\begin{remark}
	Cyclic groups $\mathbb{Z}_n$ are not simple for $n \ge 3$.\\
	Every subgroups of $\mathbb{Z}_n$ are abelian and hence a normal subgroup of $\mathbb{Z}_n$.
\end{remark}

\begin{remark}
	Symmetric group $S_3$ is not simple.\\
	$S_3$ has a proper, nontrivial, normal subgroup $\{ \rho_0, \rho_1, \rho_2 \}$. Also this group is cyclic with generator $\rho_1 = (1\ 2\ 3)$ or $\rho_2= (1\ 3\ 2)$.
\end{remark}
