...
\begin{proof}
	...
	We have, $g$ is continous on $[a,b]$, since $f_j$ are continuous on $[a,b]$.
	...
	Thus,
		\[ \bar{y}^2 = \int_a^b \left( \sum_{j=1}^k y_jf_j \right) d\alpha \le \int_a^b |\bar{y}|\ |\bar{f}| d\alpha = |\bar{y}| \int_a^b |\bar{f}| d\alpha \]
	Therefore,
