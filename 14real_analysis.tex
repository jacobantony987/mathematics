...
\begin{enumerate}
	...
	\begin{align*}
		\int_a^b f_1\ d\alpha & \le U(P,f_1,\alpha) \\
		& \le U(P,f_2,\alpha) \\
	...
	Thus,
	\begin{align*}
		\int_a^b f\ d\alpha & \le U(P^\ast,f,\alpha) \\
	...
	\item
		...
		Thus,
		\begin{align*}
			U(P,f,\alpha_1+\alpha_2) - L(P,f,\alpha_1+\alpha_2) & = \sum_{i=1}^n (M_i-m_i) \Delta (\alpha_1+\alpha_2)_i \\
		...
		\begin{align*}
			\int_a^b f\ d(\alpha_1+\alpha_2) & \le U(P,f,\alpha_1+\alpha_2) \\
...
\begin{proof}
\begin{enumerate}
	\item Let $f,g \in \mathscr{R}(\alpha)$ on $[a,b]$.
		Since $f,g \in \mathscr{R}(\alpha)$ on $[a,b]$, from linearity of the integral we have $f+g \in \mathscr{R}(\alpha)$ on $[a,b]$.
		Let $\phi(t) = t^2$.
		Then $\phi$ is continuous.
		Since $f \in \mathscr{R}(\alpha)$ and $\phi$ is continuous, we have $\phi \circ f \in \mathscr{R}(\alpha)$ on $[a,b]$.
		Also we have, $\phi \circ f = f^2$, $\phi \circ g = g^2$ and $\phi \circ (f+g) = (f+g)^2$.
		Thus, $f^2,g^2,(f+g)^2 \in \mathscr{R}(\alpha)$ on $[a,b]$.
		Now, $4fg = (f+g)^2 - f^2 - g^2$.
		...
		\hrule
	\item Let $f \in \mathscr{R}(\alpha)$ on $[a,b]$.
		Let $\phi(t) = |t|$.
		Then $\phi$ is continuous.
		Therefore, $\phi \circ f = |f| \in \mathscr{R}(\alpha)$ on $[a,b]$.\\
		Let $c = \pm 1$ such that $c \int f\ d\alpha \ge 0$.
		Then from linearity of the integral,
		\[ \left| \int f d\alpha \right| \le c \int f d\alpha = \int cf d\alpha = \int |f| d\alpha \]
\end{enumerate}
\end{proof}
