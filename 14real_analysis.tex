...
\begin{definition}[change of parameter]
	...
	Let $u : [c,d] \to [a,b]$ be a continuous, real-valued function.
	Let $g : [c,d] \to \mathbb{R}^n$ be another path.
	Then $f,g$ are \textbf{equivalent} if $g(t) = f(u(t)),\ \forall t \in [c,d]$.
	Also $f,g$ are different parametric representation of a common graph.\\
