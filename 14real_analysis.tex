...
\begin{proof}
	...
	\begin{align*}
		|a_n z^n|
		& = |P(z) - a_0 + a_1z + a_2R^2 + \dots + a_{n-1}R^{n-1}| \\
		R^n
		& \le |P(z)| + |a_0| + |a_1|R + \dots + |a_{n-1}R^{n-1} 
	\end{align*}
	Rearranging the terms, we get
	\begin{align*}
		|P(z)| 
		& \ge R^n - |a_0| - |a_1|R - |a_2|R^2 - \dots - |a_{n-1}|R^{n-1} \\
		& \ge R^n \left(1 - |a_{n-1}|R^{-1} - |a_{n-2}|R^{-2} - \dots - |a_0|R^{-n} \right)
	\end{align*}
	...
	\[ Q(z) = b_0 + b_1z + b_2z^2 + \dots + b_n z^n \]
	...
	Thus,
	\[ Q(z) = Q(re^{i\theta})| \le 1 - r^k\left(|b_k|-r|b_{k+1}| - \dots - r^{n-k}|b_n| \right) \]
