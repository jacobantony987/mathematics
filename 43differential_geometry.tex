...
\begin{proof}
	...
	\end{align*}
\end{proof}
	By the theorem for solution of system of first order ordinary differential equations, there exists and interval $I$ containing $0$ and a solution, a family of functions $\{ x_1(t), x_2(t), \cdots,x_{n+1}(t)\}$ satisfying the above system of equations and the initial condition $\alpha(0) = p$.
