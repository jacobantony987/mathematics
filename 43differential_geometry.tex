...
\subsection{Maximal Geodesic}
	...
	In essence, the following theorem says that if you are standing anywhere on an $n$-surface $S$, say $p$. You can move on that surface with any initial velocity, say $\mathbf{v}$. Keep in mind that the velocity allows you to choose both direction and speed.
